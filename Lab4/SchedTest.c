...
#define REDBLINKPRIO    2 // 7b=2, else:4
...
void BlinkGreen(void) {
	...
	if (++i % 4 == 0) {
		...
		// Activate (REDBLINKPRIO, TicksPS/2); //Uncomment for Question 6
		Activate (REDBLINKPRIO, 0); //Uncomment for Question 7
...
#define Tst1
	...
	RegisterTask(0, 0, BlinkRed, REDBLINKPRIO, DIRECT); //Question 8)
#endif
#ifdef Tst2
